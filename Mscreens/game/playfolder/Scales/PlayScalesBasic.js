...
const PlayScalesBasic = ({
  ...
  const [basicScale, setBasicScale] = useState();
  // 1 = Major pentatonic maj +2 +2 +3 +2 +3
  // 2 = Minor pentatonic min +3 +2 +2 +3 +2
  ...
  const TheMainButton = () => {
    ...
    const newRandom2 = Math.floor(randomDecimal2 * 2) + 1;
  
    setBasicScale(newRandom2);
    setGameNote(newRandom1);


    if(newRandom2===1){// 1 = Major pentatonic maj +2 +2 +3 +2 +3

      if (newRandom1 +2 > 12) 
        {
      setGameNote2(newRandom1 +2 -12)
      setGameNote3(newRandom1 +2 +2 -12)
      setGameNote4(newRandom1 +2 +2 +3 -12)
      setGameNote5(newRandom1 +2 +2 +3 +2 -12)
        }
    ...
    setGameNote5(newRandom1 +2 +2 +3 +2 -12)
      ...
      } else if (newRandom1 +2 +2 +3 +2> 12) 
      {
    setGameNote2(newRandom1 +2)
    setGameNote3(newRandom1 +2 +2)
    setGameNote4(newRandom1 +2 +2 +3)
    setGameNote5(newRandom1 +2 +2 +3 +2 -12)
    ...
    setGameNote3(newRandom1 +2 +2)
    setGameNote4(newRandom1 +2 +2 +3)
    setGameNote5(newRandom1 +2 +2 +3 +2)
      }

    } else if (newRandom2===2){ // 2 = Minor pentatonic min +3 +2 +2 +3 +2
      if (newRandom1 +3 > 12) 
        {
      setGameNote2(newRandom1 +3 -12)
      setGameNote3(newRandom1 +3 +2 -12)
      setGameNote4(newRandom1 +3 +2 +2 -12)
      setGameNote5(newRandom1 +3 +2 +2 +3 -12)
        }
      else if(newRandom1 +3 +2 > 12) 
      {
      ...
      else if (newRandom1 +3 +2 +2 > 12) 
      {
        setGameNote2(newRandom1 +3)
        setGameNote3(newRandom1 +3 +2)
        setGameNote4(newRandom1 +3 +2 +2 -12)
        setGameNote5(newRandom1 +3 +2 +2 +3 -12)
      }
       else if (newRandom1 +3 +2 +2 +3 > 12) 
      {
        setGameNote2(newRandom1 +3)
        setGameNote3(newRandom1 +3 +2)
        setGameNote4(newRandom1 +3 +2 +2)
        setGameNote5(newRandom1 +3 +2 +2 +3 -12)
      }
       else 
      {
        ...
        setGameNote3(newRandom1 +3 +2)
        setGameNote4(newRandom1 +3 +2 +2)
        setGameNote5(newRandom1 +3 +2 +2 +3)
      }
    }
    ...
    useEffect(() => {
      ...
      if (basicScale === 1) {
        setDisplayGameScale("Major");
      } else if (basicScale === 2) {
    ...
    function NotmainButton(a) {
      ...
      if (!chosenNote1) {
        ...
        if (chosenNote1 === gameNote && flag === true && chosenNote2 === gameNote2 && chosenNote3 === gameNote3 && chosenNote4 === gameNote4 && a === gameNote5) 
        {      
          setResult("Correct");
          if (user) {
            setScalesBasicTime(prevState => prevState + timer);
            setScalesBasicPlays(prevState => prevState + 1);
            save(parseFloat(scalesBasicTime) + timer, parseFloat(scalesBasicPlays) + 1);
          }
          stopTimer();
          setflag(false)
      ...
      const save = async (updatedNoteTime, updatedNotePlays) => {
        try {
          await AsyncStorage.setItem("scalesBasicTime", updatedNoteTime.toString());
          await AsyncStorage.setItem("scalesBasicPlays", updatedNotePlays.toString());
        } catch (err) {
          alert(err);
        }
      };
  ...
  <View style={styles.main}>
    ...
    <View style={styles.mainDisplay}>
      ...
      <Text style={styles.timer}>Pentatonic{'\n'} {timer > 0 ? `Timer: ${timer}` : null}</Text>
...
export default PlayScalesBasic;
