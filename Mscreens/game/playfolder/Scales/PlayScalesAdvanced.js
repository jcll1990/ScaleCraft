...
const PlayScalesAdvanced = ({
  ...
  // 1 = Major natural maj +2 +2 +1 +2 +2 +2 +1
  // 2 = Minor natural min +2 +1 +2 +2 +1 +2 +2
  ...
  const TheMainButton = () => {
    ...
    if(newRandom2 === 1){  // 1 = Harmonic minor +2 +1 +2 +2 +1 +3 +1
      ...
      setGameNote7(newRandom1 +2 +1 +2 +2 +1 +3 -12)
        }
      ...
      else if (newRandom1 +2 +1 +2 +2 +1> 12) 
      {
       ...
       else if (newRandom1 +2 +1 +2 +2 +1 +3 > 12) 
      {
        setGameNote2(newRandom1 +2)
        setGameNote3(newRandom1 +2 +1)
        setGameNote4(newRandom1 +2 +1 +2)
      ...
      else 
      {
        ...
        setGameNote5(newRandom1 +2 +1 +2 +2)
        setGameNote6(newRandom1 +2 +1 +2 +2 +1)
        setGameNote7(newRandom1 +2 +1 +2 +2 +1 +3)
      } 
    }  else if(newRandom2 === 2 ){  // 2 Melodic minor = +2 +1 +2 +2 +2 +2 +1
            ...
            setGameNote7(newRandom1 +2 +1 +2 +2 +2 +2 -12)
              }
            else if (newRandom1 +2 +1> 12) 
            {
              setGameNote2(newRandom1 +2)
            ...
            else if (newRandom1 +2 +1 +2 +2 +2> 12) 
            {
             ...
             else if (newRandom1 +2 +1 +2 +2 +2 +2 > 12) 
            {
              setGameNote2(newRandom1 +2)
              setGameNote3(newRandom1 +2 +1)
              setGameNote4(newRandom1 +2 +1 +2)
            ...
            else 
            {
              ...
              setGameNote5(newRandom1 +2 +1 +2 +2)
              setGameNote6(newRandom1 +2 +1 +2 +2 +2)
              setGameNote7(newRandom1 +2 +1 +2 +2 +2 +2)
            } 
          }  
    ...
    useEffect(() => {
      ...
      if (basicChord === 1) {
        setDisplayGameScale("Harmonic minor");
      } else if (basicChord === 2) {
        setDisplayGameScale("Melodic minor");
      } 
    ...
    function NotmainButton(a) {
      ...
      if (!chosenNote1) {
        ...
        {      
          setResult("Correct");
          if (user) {
            setScalesAdvancedTime(prevState => prevState + timer);
            setScalesAdvancedPlays(prevState => prevState + 1);
            save(parseFloat(scalesAdvancedTime) + timer, parseFloat(scalesAdvancedPlays) + 1);
          }
          stopTimer();
          setflag(false)
      ...
      const save = async (updatedNoteTime, updatedNotePlays) => {
        try {
          await AsyncStorage.setItem("scalesAdvancedTime", updatedNoteTime.toString());
          await AsyncStorage.setItem("scalesAdvancedPlays", updatedNotePlays.toString());
        } catch (err) {
          alert(err);
        }
      };
  ...
  <View style={styles.main}>
    ...
    <View style={styles.mainDisplay}>
      ...
      <Text style={styles.timer}>Harmonic - Melodic{'\n'} {timer > 0 ? `Timer: ${timer}` : null}</Text>
...
export default PlayScalesAdvanced;
